    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-6 text-sm font-medium text-slate-300">
          ...
          <button onClick={() => scrollToSection('what-you-will-learn')} className="hover:text-blue-400 transition-colors">
            What You'll Learn
          </button>
          <button onClick={() => scrollToSection('instructor')} className="hover:text-blue-400 transition-colors">
            Instructor
          </button>
        ...
        <div className="hidden md:flex items-center space-x-4">
          <div className="text-right">
            ...
            <span className="text-sm font-black text-emerald-400">₹111 ONLY</span>
          </div>
          <button
            onClick={() => scrollToSection('register')}
            className="group relative inline-flex items-center justify-center px-5 py-2.5 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-sky-600 hover:from-blue-500 hover:to-sky-500 transition-all duration-200 shadow-md shadow-blue-600/30 active:scale-95"
          >
            <span>Join for ₹111</span>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-slate-900/95 border-b border-slate-800 px-4 pt-3 pb-6 space-y-4 shadow-xl">
          <div className="flex flex-col space-y-3 text-sm font-medium text-slate-300">
            <button onClick={() => scrollToSection('value-section')} className="text-left py-2 hover:text-blue-400">
              Why Learn
            </button>
            <button onClick={() => scrollToSection('what-you-will-learn')} className="text-left py-2 hover:text-blue-400">
              What You'll Learn
            </button>
            <button onClick={() => scrollToSection('instructor')} className="text-left py-2 hover:text-blue-400">
              Instructor
            </button>
          ...
          <div className="pt-2 border-t border-slate-800 flex items-center justify-between">
            <div>
              <span className="text-xs text-slate-400 block line-through">₹999</span>
              <span className="text-base font-extrabold text-emerald-400">Special Price: ₹111</span>
            </div>
            <button
              onClick={() => scrollToSection('register')}
