  ...
  return (
    <section id="pricing" className="py-20 md:py-28 bg-slate-900/80 border-t border-slate-800 text-white relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Scarcity Banner */}
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-3 px-6 text-center text-amber-300 text-xs sm:text-sm font-semibold mb-8 flex items-center justify-center gap-2">
          ...
          <span className="hidden sm:inline">• Seats filling fast!</span>
        </div>
